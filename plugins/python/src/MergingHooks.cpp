...
void bind_Pythia8_MergingHooks(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // Pythia8::MergingHooks file:Pythia8/MergingHooks.h line:166
		...
		{ // Pythia8::MergingHooks::IndividualWeights file:Pythia8/MergingHooks.h line:613
		...
		cl.def_readwrite("doDynamicMergingSave", &Pythia8::MergingHooks::doDynamicMergingSave);
		...
		cl.def_readwrite("SparameterSave", &Pythia8::MergingHooks::SparameterSave);
		...
		cl.def("doDynamicMerging", (bool (Pythia8::MergingHooks::*)()) &Pythia8::MergingHooks::doDynamicMerging, "C++: Pythia8::MergingHooks::doDynamicMerging() --> bool");
