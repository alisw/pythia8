...
void Parameters_sm::setIndependentParameters(Pythia8::ParticleData * & pd, 
Pythia8::CoupSM * & csm, Pythia8::SusyLesHouches * & slhaPtr)
{
  if (false)
    cout << pd << csm << slhaPtr; 
  mdl_WH = pd->mWidth(25); 
...
void Parameters_sm::setDependentParameters(Pythia8::ParticleData * & pd, 
Pythia8::CoupSM * & csm, Pythia8::SusyLesHouches * & slhaPtr, double alpS)
{
  if (false)
