...
#ifndef PY8MEs_R1_P2_sm_z_bbx_H
#define PY8MEs_R1_P2_sm_z_bbx_H
...
class PY8MEs_R1_P2_sm_z_bbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R1_P2_sm_z_bbx(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R1_P2_sm_z_bbx(); 
    ...
    virtual string name() const {return "z_bbx (sm)";}
