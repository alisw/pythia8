...
#ifndef PY8MEs_R1_P1_sm_z_qq_H
#define PY8MEs_R1_P1_sm_z_qq_H
...
class PY8MEs_R1_P1_sm_z_qq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R1_P1_sm_z_qq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R1_P1_sm_z_qq(); 
    ...
    virtual string name() const {return "z_qq (sm)";}
  ...
  private:
    ...
    double matrix_1_z_uux(); 
    double matrix_1_z_ddx(); 
