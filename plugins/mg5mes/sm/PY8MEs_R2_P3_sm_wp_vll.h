...
#ifndef PY8MEs_R2_P3_sm_wp_vll_H
#define PY8MEs_R2_P3_sm_wp_vll_H
...
class PY8MEs_R2_P3_sm_wp_vll : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P3_sm_wp_vll(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P3_sm_wp_vll(); 
    ...
    virtual string name() const {return "wp_vll (sm)";}
  ...
  private:
    ...
    double matrix_2_wp_veep(); 
    double matrix_2_wm_emvex(); 
...
#endif  // PY8MEs_R2_P3_sm_wp_vll_H
