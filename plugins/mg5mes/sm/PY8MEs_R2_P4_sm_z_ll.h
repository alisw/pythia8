...
#ifndef PY8MEs_R2_P4_sm_z_ll_H
#define PY8MEs_R2_P4_sm_z_ll_H
...
class PY8MEs_R2_P4_sm_z_ll : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P4_sm_z_ll(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P4_sm_z_ll(); 
    ...
    virtual string name() const {return "z_ll (sm)";}
  ...
  private:
    ...
    double matrix_2_z_emep(); 
    double matrix_2_z_vevex(); 
