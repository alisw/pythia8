...
#ifndef PY8MEs_R1_P0_sm_wp_qq_H
#define PY8MEs_R1_P0_sm_wp_qq_H
...
class PY8MEs_R1_P0_sm_wp_qq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R1_P0_sm_wp_qq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R1_P0_sm_wp_qq(); 
    ...
    virtual string name() const {return "wp_qq (sm)";}
  ...
  private:
    ...
    double matrix_1_wp_udx(); 
    double matrix_1_wm_dux(); 
